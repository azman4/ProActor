...
public class buyBusinessPlan {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			String sheetName = "BuyBusinessPlan";
			...
			for (int row = 1; row <= valueSheet.getLastRowNum(); row++) {
				...
				String address = Library.getParameterFromInputSheet(sheetName, "Address", row);
				...
				Library.buyBusinessPlanPage(logger);
				Library.buyBusinessPlan(address, logger);
			}
